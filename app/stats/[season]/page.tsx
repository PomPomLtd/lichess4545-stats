...
export default function SeasonPage() {
  ...
  const fetchAvailableRounds = async () => {
    try {
      ...
      // Try to fetch stats for rounds 1-8 (standard season length)
      ...
      <div className="space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
            Deep dive into the games, tactics, and patterns from the Lichess 4545 League
          </p>
        </div>
        ...
        {availableRounds.length > 0 && (
          <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-lg shadow-xl p-8 text-white">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-6">
              <div>
                <h2 className="text-2xl font-bold mb-2">Season {season} Overview</h2>
              </div>
              {availableRounds.length >= 2 && (
                <Link href={`/stats/${season}/overview`}>
          ...
          {availableRounds.length === 0 ? (
            <div className="text-center py-12 bg-gray-50 dark:bg-gray-800 rounded-lg">
              <div className="text-gray-500 dark:text-gray-400 mb-2">
                No statistics available yet for Season {season}
              </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <div className="mt-2 text-sm text-blue-700 dark:text-blue-300 space-y-1">
                <p>• Statistics generated from Lichess 4545 League PGN game records</p>
                <p>• Includes opening analysis, tactical patterns, piece activity, and board heatmaps</p>
